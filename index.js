...
const stripe = require('stripe')(process.env.STRIPE_SECRET_KEY) // you have to require stripe
const app = express();
...
async function run() {
    try {
        ...
        app.post('/users', async (req, res) => {
            ...
            // you can do it various ways( 1. email unique, 2. upsert, 3. simple checking)
